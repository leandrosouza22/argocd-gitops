...
SVC_NAME="actions.runner.leandrosouza22-argocd-gitops.MacBook-Pro-de-Leandro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (leandrosouza22-argocd-gitops.MacBook-Pro-de-Leandro)"
